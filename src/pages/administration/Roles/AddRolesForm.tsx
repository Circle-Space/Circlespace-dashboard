...
const AddRolesForm = () => {
    ...
    const initialValues = {
        Name: "",
        Description: "",
        Features: [], // Assuming Features is an array
    ...
    return (
        <Container>
            <Card>
                <Card.Title className="px-3 pt-3 pb-0 mb-0">Add New Role</Card.Title>
