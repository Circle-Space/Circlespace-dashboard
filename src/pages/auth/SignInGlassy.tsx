    ...
    <React.Fragment>
      ...
      <style jsx>{`
        ...
        .glassy-card {
          ...
          box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.37), 0 0 0 1px rgba(255, 255, 255, 0.18) inset, 0 0 100px 0 rgba(0, 0, 0, 0.1);
          overflow: hidden;
          transition: box-shadow 0.3s ease;
        }

        .glassy-card:hover {
          box-shadow: 0 15px 35px 0 rgba(31, 38, 135, 0.45), 0 0 0 1px rgba(255, 255, 255, 0.2) inset, 0 0 120px 0 rgba(0, 0, 0, 0.1);
        }
