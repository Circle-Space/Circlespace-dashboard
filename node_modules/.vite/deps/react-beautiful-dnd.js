import {
  _objectSpread2
} from "./chunk-OIGK5WQP.js";
import "./chunk-GZ277VAG.js";
import {
  _inheritsLoose
} from "./chunk-ZTT5NWX6.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-KFQDCDOS.js";
import {
  _extends
} from "./chunk-KGAGRUAU.js";
import {
  require_hoist_non_react_statics_cjs
} from "./chunk-LZUNOUHV.js";
import "./chunk-I6OF3EWK.js";
import {
  require_react_dom
} from "./chunk-JFI3BA7V.js";
import {
  require_prop_types
} from "./chunk-GCKUGKLU.js";
import "./chunk-SLZI6Q36.js";
import {
  require_react
...
function createStore(reducer2, preloadedState, enhancer) {
  ...
  if (typeof reducer2 !== "function") {
    throw new Error(import_process.default.env.NODE_ENV === "production" ? formatProdErrorMessage(2) : "Expected the root reducer to be a function. Instead, received: '" + kindOf(reducer2) + "'");
  }
  ...
  function subscribe(listener) {
    if (typeof listener !== "function") {
      throw new Error(import_process.default.env.NODE_ENV === "production" ? formatProdErrorMessage(4) : "Expected the listener to be a function. Instead, received: '" + kindOf(listener) + "'");
    }
    if (isDispatching) {
...
var isProduction2 = import_process.default.env.NODE_ENV === "production";
...
var isProduction$1 = import_process.default.env.NODE_ENV === "production";
  ...
  function ErrorBoundary2() {
    ...
    _this.onWindowError = function(event) {
      ...
      if (callbacks.isDragging()) {
        callbacks.tryAbort();
        import_process.default.env.NODE_ENV !== "production" ? warning2("\n        An error was caught by our window 'error' event listener while a drag was occurring.\n        The active drag has been aborted.\n      ") : void 0;
      }
      var err = event.error;
...
var scrollDroppable = function(droppable2, newScroll) {
  !droppable2.frame ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false) : invariant2(false) : void 0;
...
var moveToNextCombine = function(_ref) {
  ...
  !(indexOfClosest !== -1) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Could not find displaced item in set") : invariant2(false) : void 0;
...
var moveToNextIndex = function(_ref) {
  ...
  !wasAt ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot move in direction without previous impact location") : invariant2(false) : void 0;
...
var whenCombining = function(_ref) {
  ...
  !combine2 ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false) : invariant2(false) : void 0;
...
var getKnownActive = function getKnownActive2(droppable2) {
  ...
  !rect ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot get clipped area from droppable") : invariant2(false) : void 0;
  return rect;
};
...
var addPlaceholder = function addPlaceholder2(droppable2, draggable2, draggables) {
  var frame = droppable2.frame;
  !!isHomeOf(draggable2, droppable2) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Should not add placeholder space to home list") : invariant2(false) : void 0;
  !!droppable2.subject.withPlaceholder ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot add placeholder size to a subject when it already has one") : invariant2(false) : void 0;
...
var removePlaceholder = function removePlaceholder2(droppable2) {
  ...
  !added ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot remove placeholder form subject when there was none") : invariant2(false) : void 0;
  var frame = droppable2.frame;
  if (!frame) {
  ...
  !oldMaxScroll ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Expected droppable with frame to have old max frame scroll when removing placeholder") : invariant2(false) : void 0;
...
var refreshSnap = function(_ref) {
  ...
  !(state.movementMode === "SNAP") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false) : invariant2(false) : void 0;
  ...
  !isOver ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Must be over a destination in SNAP movement mode") : invariant2(false) : void 0;
...
var getLiftEffect = function(_ref) {
  ...
  !(rawIndex !== -1) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Expected draggable to be inside home list") : invariant2(false) : void 0;
...
var getFrame = function(droppable2) {
  var frame = droppable2.frame;
  !frame ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Expected Droppable to have a frame") : invariant2(false) : void 0;
  return frame;
};
...
var reducer = function(state, action) {
  ...
  if (action.type === "INITIAL_PUBLISH") {
    !(state.phase === "IDLE") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "INITIAL_PUBLISH must come after a IDLE phase") : invariant2(false) : void 0;
  ...
  if (action.type === "COLLECTION_STARTING") {
    ...
    !(state.phase === "DRAGGING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Collection cannot start from phase " + state.phase) : invariant2(false) : void 0;
  ...
  if (action.type === "PUBLISH_WHILE_DRAGGING") {
    !(state.phase === "COLLECTING" || state.phase === "DROP_PENDING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Unexpected " + action.type + " received in phase " + state.phase) : invariant2(false) : void 0;
  ...
  if (action.type === "MOVE") {
    ...
    !isMovementAllowed(state) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, action.type + " not permitted in phase " + state.phase) : invariant2(false) : void 0;
  ...
  if (action.type === "UPDATE_DROPPABLE_IS_ENABLED") {
    ...
    !isMovementAllowed(state) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Attempting to move in an unsupported phase " + state.phase) : invariant2(false) : void 0;
    var _action$payload3 = action.payload, _id = _action$payload3.id, isEnabled = _action$payload3.isEnabled;
    var _target = state.dimensions.droppables[_id];
    !_target ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot find Droppable[id: " + _id + "] to toggle its enabled state") : invariant2(false) : void 0;
    !(_target.isEnabled !== isEnabled) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Trying to set droppable isEnabled to " + String(isEnabled) + "\n      but it is already " + String(_target.isEnabled)) : invariant2(false) : void 0;
  ...
  if (action.type === "UPDATE_DROPPABLE_IS_COMBINE_ENABLED") {
    ...
    !_target2 ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot find Droppable[id: " + _id2 + "] to toggle its isCombineEnabled state") : invariant2(false) : void 0;
    !(_target2.isCombineEnabled !== isCombineEnabled) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Trying to set droppable isCombineEnabled to " + String(isCombineEnabled) + "\n      but it is already " + String(_target2.isCombineEnabled)) : invariant2(false) : void 0;
  ...
  if (action.type === "MOVE_BY_WINDOW_SCROLL") {
    ...
    !isMovementAllowed(state) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot move by window in phase " + state.phase) : invariant2(false) : void 0;
    !state.isWindowScrollAllowed ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Window scrolling is currently not supported for fixed lists") : invariant2(false) : void 0;
  ...
  if (action.type === "MOVE_UP" || action.type === "MOVE_DOWN" || action.type === "MOVE_LEFT" || action.type === "MOVE_RIGHT") {
    ...
    !(state.phase === "DRAGGING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, action.type + " received while not in DRAGGING phase") : invariant2(false) : void 0;
  ...
  if (action.type === "DROP_PENDING") {
    ...
    !(state.phase === "COLLECTING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Can only move into the DROP_PENDING phase from the COLLECTING phase") : invariant2(false) : void 0;
  ...
  if (action.type === "DROP_ANIMATE") {
    ...
    !(state.phase === "DRAGGING" || state.phase === "DROP_PENDING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot animate drop from phase " + state.phase) : invariant2(false) : void 0;
    var _result3 = {
  ...
  return function(_ref) {
    ...
    return function(next) {
      return function(action) {
        ...
        !(getState().phase === "IDLE") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Unexpected phase to start a drag") : invariant2(false) : void 0;
        dispatch(flush());
...
var drop$1 = function(_ref) {
  ...
  return function(next) {
    return function(action) {
      ...
      !!isWaitingForDrop ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "A DROP action occurred while DROP_PENDING and still waiting") : invariant2(false) : void 0;
      !(state.phase === "DRAGGING" || state.phase === "DROP_PENDING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot drop in phase: " + state.phase) : invariant2(false) : void 0;
...
function getScrollListener(_ref) {
  ...
  function start3() {
    !!isActive() ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot start scroll listener when already active") : invariant2(false) : void 0;
    unbind = bindEvents(window, [binding]);
  }
  function stop() {
    !isActive() ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot stop scroll listener when not active") : invariant2(false) : void 0;
    scheduled.cancel();
    unbind();
    unbind = noop;
  }
...
var getExpiringAnnounce = function(announce) {
  ...
  var result = function result2(message) {
    if (wasCalled) {
      import_process.default.env.NODE_ENV !== "production" ? warning2("Announcement already made. Not making a second announcement") : void 0;
      return;
    }
    if (isExpired) {
...
var getAsyncMarshal = function() {
  ...
  var execute3 = function execute4(timerId) {
    ...
    !(index !== -1) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Could not find timer") : invariant2(false) : void 0;
...
var getPublisher = function(getResponders, announce) {
  ...
  var beforeCapture = function beforeCapture2(draggableId, mode) {
    !!dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot fire onBeforeCapture as a drag start has already been published") : invariant2(false) : void 0;
  ...
  var beforeStart = function beforeStart2(critical, mode) {
    !!dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot fire onBeforeDragStart as a drag start has already been published") : invariant2(false) : void 0;
  ...
  var update2 = function update3(critical, impact) {
    ...
    var combine2 = tryGetCombine(impact);
    !dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot fire onDragMove when onDragStart has not been called") : invariant2(false) : void 0;
  ...
  var flush3 = function flush4() {
    !dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Can only flush responders while dragging") : invariant2(false) : void 0;
    asyncMarshal.flush();
  };
  var drop5 = function drop6(result) {
    !dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot fire onDragEnd when there is no matching onDragStart") : invariant2(false) : void 0;
    dragging = null;
...
var dropAnimationFinish = function(store) {
  return function(next) {
    return function(action) {
      ...
      var state = store.getState();
      !(state.phase === "DROP_ANIMATING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot finish a drop animating when no drop is occurring") : invariant2(false) : void 0;
    ...
    return function(next) {
      return function(action) {
        ...
        if (action.type === "INITIAL_PUBLISH") {
          next(action);
          var state = store.getState();
          !(state.phase === "DRAGGING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Expected phase to be DRAGGING after INITIAL_PUBLISH") : invariant2(false) : void 0;
...
var composeEnhancers = import_process.default.env.NODE_ENV !== "production" && typeof window !== "undefined" && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({
...
var getDocumentElement = function() {
  ...
  !doc ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot find document.documentElement") : invariant2(false) : void 0;
  return doc;
};
...
var createDimensionMarshal = function(registry, callbacks) {
  ...
  var updateDroppableIsEnabled3 = function updateDroppableIsEnabled4(id, isEnabled) {
    !registry.droppable.exists(id) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot update is enabled flag of Droppable " + id + " as it is not registered") : invariant2(false) : void 0;
    if (!collection) {
      return;
    }
  ...
  var updateDroppableIsCombineEnabled3 = function updateDroppableIsCombineEnabled4(id, isCombineEnabled) {
    ...
    !registry.droppable.exists(id) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot update isCombineEnabled flag of Droppable " + id + " as it is not registered") : invariant2(false) : void 0;
  ...
  var updateDroppableScroll3 = function updateDroppableScroll4(id, newScroll) {
    ...
    !registry.droppable.exists(id) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot update the scroll on Droppable " + id + " as it is not registered") : invariant2(false) : void 0;
  ...
  var subscriber = function subscriber2(event) {
    !collection ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Should only be subscribed when a collection is occurring") : invariant2(false) : void 0;
  ...
  var startPublishing = function startPublishing2(request) {
    !!collection ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot start capturing critical dimensions as there is already a collection") : invariant2(false) : void 0;
...
var getScrollableDroppableOver = function getScrollableDroppableOver2(target, droppables) {
  var maybe = find(getScrollableDroppables(droppables), function(droppable2) {
    !droppable2.frame ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Invalid result") : invariant2(false) : void 0;
...
var createFluidScroller = function(_ref) {
  ...
  var tryScroll = function tryScroll2(state) {
    !dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot fluid scroll if not dragging") : invariant2(false) : void 0;
  ...
  var start$1 = function start$12(state) {
    start();
    !!dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot start auto scrolling when already started") : invariant2(false) : void 0;
...
var createJumpScroller = function(_ref) {
  ...
  var jumpScroller = function jumpScroller2(state) {
    ...
    !destination ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot perform a jump scroll when there is no destination") : invariant2(false) : void 0;
...
var getHead = function getHead2() {
  ...
  !head ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot find the head to append a style to") : invariant2(false) : void 0;
  return head;
};
...
function useStyleMarshal(contextId, nonce) {
  ...
  var setDynamicStyle = useCallback(memoize_one_esm_default(function(proposed) {
    ...
    !el ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot set dynamic style element if it is not set") : invariant2(false) : void 0;
  ...
  useIsomorphicLayoutEffect2(function() {
    !(!alwaysRef.current && !dynamicRef.current) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "style elements already mounted") : invariant2(false) : void 0;
    ...
    return function() {
      var remove = function remove2(ref2) {
        ...
        !current ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot unmount ref as it is not set") : invariant2(false) : void 0;
...
function findDragHandle(contextId, draggableId) {
  ...
  if (!possible.length) {
    import_process.default.env.NODE_ENV !== "production" ? warning2('Unable to find any drag handles in the context "' + contextId + '"') : void 0;
    return null;
  }
  ...
  if (!handle) {
    import_process.default.env.NODE_ENV !== "production" ? warning2('Unable to find drag handle with id "' + draggableId + '" as no handle with a matching id was found') : void 0;
    return null;
  }
  if (!isHtmlElement(handle)) {
    import_process.default.env.NODE_ENV !== "production" ? warning2("drag handle needs to be a HTMLElement") : void 0;
    return null;
  }
  return handle;
}
...
function createRegistry() {
  ...
  function getDraggableById(id) {
    ...
    !entry ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot find draggable entry with id [" + id + "]") : invariant2(false) : void 0;
    return entry;
  }
  var draggableAPI = {
  ...
  function getDroppableById(id) {
    ...
    !entry ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot find droppable entry with id [" + id + "]") : invariant2(false) : void 0;
    return entry;
  }
  var droppableAPI = {
    register: function register(entry) {
...
var getBodyElement = function() {
  ...
  !body ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot find document.body") : invariant2(false) : void 0;
  return body;
};
var visuallyHidden = {
  position: "absolute",
...
var getVersion = function getVersion2(value) {
  ...
  !(result != null) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Unable to parse React version " + value) : invariant2(false) : void 0;
...
function create() {
  ...
  function claim(abandon) {
    !!lock ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot claim lock as it is already claimed") : invariant2(false) : void 0;
    var newLock = {
      abandon
    };
    lock = newLock;
  ...
  function release() {
    !lock ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot release lock when there is no lock") : invariant2(false) : void 0;
    lock = null;
  }
  function tryAbandon() {
    if (lock) {
...
function getCaptureBindings(_ref) {
  ...
  return [{
    ...
    fn: function fn(event) {
      ...
      !(phase.type === "PENDING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot be IDLE") : invariant2(false) : void 0;
    ...
    fn: function fn(event) {
      var phase = getPhase();
      !(phase.type !== "IDLE") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Unexpected phase") : invariant2(false) : void 0;
...
function useMouseSensor(api) {
  ...
  var startPendingDrag = useCallback(function startPendingDrag2(actions, point) {
    !(phaseRef.current.type === "IDLE") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Expected to move from IDLE to PENDING drag") : invariant2(false) : void 0;
    phaseRef.current = {
      type: "PENDING",
      point,
      actions
  ...
  var startCaptureBinding = useMemo4(function() {
    return {
      ...
      fn: function onKeyDown(event) {
        ...
        unbindEventsRef.current();
        function stop() {
          !isCapturing ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot stop capturing a keyboard drag when not capturing") : invariant2(false) : void 0;
          isCapturing = false;
          unbindEventsRef.current();
          listenForCapture();
        }
...
function getHandleBindings(_ref2) {
  ...
  return [{
    ...
    fn: function fn(event) {
      var phase = getPhase();
      !(phase.type !== "IDLE") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false) : invariant2(false) : void 0;
...
function useTouchSensor(api) {
  ...
  var startDragging = useCallback(function startDragging2() {
    var phase = getPhase();
    !(phase.type === "PENDING") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot start dragging from phase " + phase.type) : invariant2(false) : void 0;
  ...
  var startPendingDrag = useCallback(function startPendingDrag2(actions, point) {
    !(getPhase().type === "IDLE") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Expected to move from IDLE to PENDING drag") : invariant2(false) : void 0;
...
function useValidateSensorHooks(sensorHooks) {
  useDev(function() {
    ...
    useDevSetupWarning(function() {
      !(previousRef.current.length === sensorHooks.length) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot change the amount of sensor hooks after mounting") : invariant2(false) : void 0;
    });
  });
}
...
function findClosestDragHandleFromEvent(contextId, event) {
  var target = event.target;
  if (!isElement(target)) {
    import_process.default.env.NODE_ENV !== "production" ? warning2("event.target must be a Element") : void 0;
    return null;
  }
  ...
  if (!isHtmlElement(handle)) {
    import_process.default.env.NODE_ENV !== "production" ? warning2("drag handle must be a HTMLElement") : void 0;
    return null;
  }
  return handle;
}
...
function findDraggable(contextId, draggableId) {
  ...
  if (!isHtmlElement(draggable$1)) {
    import_process.default.env.NODE_ENV !== "production" ? warning2("Draggable element is not a HTMLElement") : void 0;
    return null;
  }
  return draggable$1;
}
...
function canStart(_ref2) {
  ...
  if (!entry) {
    import_process.default.env.NODE_ENV !== "production" ? warning2("Unable to find draggable with id: " + draggableId) : void 0;
    return false;
  }
...
function tryStart(_ref3) {
  ...
  if (!el) {
    import_process.default.env.NODE_ENV !== "production" ? warning2("Unable to find draggable element with id: " + draggableId) : void 0;
    return null;
  }
  ...
  function lift$12(args) {
    ...
    if (phase !== "PRE_DRAG") {
      completed();
      !(phase === "PRE_DRAG") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot lift in phase " + phase) : invariant2(false) : void 0;
    }
...
function getStore(lazyRef) {
  !lazyRef.current ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Could not find store from lazy ref") : invariant2(false) : void 0;
...
function App(props) {
  ...
  if (import_process.default.env.NODE_ENV !== "production") {
    if (lazyStoreRef.current && lazyStoreRef.current !== store) {
      import_process.default.env.NODE_ENV !== "production" ? warning2("unexpected store change") : void 0;
    }
  }
...
var isBodyScrollable = function isBodyScrollable2() {
  ...
  !html ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false) : invariant2(false) : void 0;
...
function useRequiredContext(Context) {
  ...
  !result ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Could not find required context") : invariant2(false) : void 0;
  return result;
}
...
function useDroppablePublisher(args) {
  ...
  var memoizedUpdateScroll = useMemo4(function() {
    return memoize_one_esm_default(function(x, y) {
      !whileDraggingRef.current ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Can only update scroll when dragging") : invariant2(false) : void 0;
      var scroll4 = {
        x,
        y
      };
  ...
  var onClosestScroll = useCallback(function() {
    ...
    !(dragging && closest3) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Could not find scroll options while scrolling") : invariant2(false) : void 0;
  ...
  var getDimensionAndWatchScroll = useCallback(function(windowScroll, options) {
    !!whileDraggingRef.current ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot collect a droppable while a drag is occurring") : invariant2(false) : void 0;
    var previous = previousRef.current;
    var ref2 = previous.getDroppableRef();
    !ref2 ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot collect without a droppable ref") : invariant2(false) : void 0;
    var env = getEnv(ref2);
    var dragging = {
      ref: ref2,
      descriptor,
  ...
  var getScrollWhileDragging = useCallback(function() {
    var dragging = whileDraggingRef.current;
    var closest3 = getClosestScrollableFromDrag(dragging);
    !(dragging && closest3) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Can only recollect Droppable client for Droppables that have a scroll container") : invariant2(false) : void 0;
    return getScroll$1(closest3);
  }, []);
  var dragStopped = useCallback(function() {
    var dragging = whileDraggingRef.current;
    !dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot stop drag when no active drag") : invariant2(false) : void 0;
    var closest3 = getClosestScrollableFromDrag(dragging);
  ...
  var scroll3 = useCallback(function(change) {
    var dragging = whileDraggingRef.current;
    !dragging ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot scroll when there is no drag") : invariant2(false) : void 0;
    var closest3 = getClosestScrollableFromDrag(dragging);
    !closest3 ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot scroll a droppable with no closest scrollable") : invariant2(false) : void 0;
  ...
  useIsomorphicLayoutEffect2(function() {
    ...
    return function() {
      if (whileDraggingRef.current) {
        import_process.default.env.NODE_ENV !== "production" ? warning2("Unsupported: changing the droppableId or type of a Droppable during a drag") : void 0;
        dragStopped();
      }
...
function checkIsValidInnerRef(el) {
  !(el && isHtmlElement(el)) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "\n    provided.innerRef has not been provided with a HTMLElement.\n\n    You can find a guide on using the innerRef callback functions at:\n    https://github.com/atlassian/react-beautiful-dnd/blob/master/docs/guides/using-inner-ref.md\n  ") : invariant2(false) : void 0;
}
...
var shared = [function required(_ref) {
  ...
  !props.droppableId ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "A Droppable requires a droppableId prop") : invariant2(false) : void 0;
  !(typeof props.droppableId === "string") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "A Droppable requires a [string] droppableId. Provided: [" + typeof props.droppableId + "]") : invariant2(false) : void 0;
}, function _boolean(_ref2) {
  var props = _ref2.props;
  !isBoolean(props.isDropDisabled) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "isDropDisabled must be a boolean") : invariant2(false) : void 0;
  !isBoolean(props.isCombineEnabled) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "isCombineEnabled must be a boolean") : invariant2(false) : void 0;
  !isBoolean(props.ignoreContainerClipping) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "ignoreContainerClipping must be a boolean") : invariant2(false) : void 0;
}, function ref(_ref3) {
...
var virtual = [function hasClone(_ref5) {
  ...
  !props.renderClone ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Must provide a clone render function (renderClone) for virtual lists") : invariant2(false) : void 0;
}, function hasNoPlaceholder(_ref6) {
  var getPlaceholderRef = _ref6.getPlaceholderRef;
  !!getPlaceholderRef() ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Expected virtual list to not have a placeholder") : invariant2(false) : void 0;
}];
...
function useDraggablePublisher(args) {
  ...
  var getDimension2 = useCallback(function(windowScroll) {
    ...
    !el ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Cannot get dimension when no ref is set") : invariant2(false) : void 0;
...
function useValidation$1(props, contextId, getRef) {
  useDevSetupWarning(function() {
    ...
    !id ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Draggable requires a draggableId") : invariant2(false) : void 0;
    !(typeof id === "string") ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Draggable requires a [string] draggableId.\n      Provided: [type: " + typeof id + "] (value: " + id + ")") : invariant2(false) : void 0;
    !isInteger(props.index) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, prefix3(id) + " requires an integer index prop") : invariant2(false) : void 0;
    if (props.mapped.type === "DRAGGING") {
      return;
    }
    checkIsValidInnerRef(getRef());
    if (props.isEnabled) {
      !findDragHandle(contextId, id) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, prefix3(id) + " Unable to find drag handle") : invariant2(false) : void 0;
    }
  });
}
function useClonePropValidation(isClone) {
  useDev(function() {
    ...
    useDevSetupWarning(function() {
      !(isClone === initialRef.current) ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Draggable isClone prop value changed during component life") : invariant2(false) : void 0;
    }, [isClone]);
  });
}
...
function Droppable(props) {
  ...
  !appContext ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "Could not find app context") : invariant2(false) : void 0;
...
function getBody() {
  !document.body ? import_process.default.env.NODE_ENV !== "production" ? invariant2(false, "document.body is not ready") : invariant2(false) : void 0;
