...
function Field(_ref) {
  ...
  if (import_process.default.env.NODE_ENV !== "production") {
    (0, import_react.useEffect)(function() {
      ...
      !!(is && children && isFunction(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <Field as> and <Field children> as a function in the same <Field> component; <Field as> will be ignored.") : tiny_warning_esm_default(false) : void 0;
      !!(component && children && isFunction(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <Field component> and <Field children> as a function in the same <Field> component; <Field component> will be ignored.") : tiny_warning_esm_default(false) : void 0;
...
var FastFieldInner = function(_React$Component) {
  ...
  function FastFieldInner2(props) {
    ...
    !!(is && children && isFunction(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <FastField as> and <FastField children> as a function in the same <FastField> component; <FastField as> will be ignored.") : tiny_warning_esm_default(false) : void 0;
    !!(component && children && isFunction(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <FastField component> and <FastField children> as a function in the same <FastField> component; <FastField component> will be ignored.") : tiny_warning_esm_default(false) : void 0;
